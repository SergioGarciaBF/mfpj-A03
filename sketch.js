...
function draw() {
  ...
  //Calcular b para cada equação da reta: n = y - mx
  ...
  if (mAB === mCD && nAB === nCD){
    console.log("Os segmentos são colineares")
    ...
    console.log("Iniciar verificação de cruzamento")
    ...
    if(xComum >= ax && xComum <= bx && xComum >= cx && xComum<=dx){
      console.log("xComum dentro dos intervalos")
      ...
      text("Os segmentos se cruzam em um único ponto", 200, 600)
